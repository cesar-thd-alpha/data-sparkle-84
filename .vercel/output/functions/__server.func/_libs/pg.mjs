...
var require_postgres_interval = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var INTERVAL = new RegExp(
    [YEAR, MONTH, DAY, "([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?"]
...
var require_sasl = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  async function continueSession(session, password, serverData, stream) {
    ...
    const scramMaxIterations =
      typeof session.scramMaxIterations === "number"
        ? session.scramMaxIterations
...
var require_connection_parameters = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var val = function (key, config, envVar) {
    ...
    } else envVar = process.env[envVar];
  ...
  var ConnectionParameters = class {
    constructor(config) {
      ...
      if (
        this.sslnegotiation !== void 0 &&
        this.sslnegotiation !== "postgres" &&
        this.sslnegotiation !== "direct"
      )
        throw new Error(
  ...
  var Query = class extends EventEmitter$5 {
    ...
    submit(connection) {
      ...
      if (this.values && !Array.isArray(this.values))
        return /* @__PURE__ */ new Error("Query values must be an array");
      ...
      this.stream.once("data", function (buffer) {
        switch (buffer.toString("utf8")) {
          ...
          case "N":
            ...
            return self.emit(
              "error",
              /* @__PURE__ */ new Error("The server does not support SSL connections"),
            );
          default:
            self.stream.end();
            return self.emit(
              "error",
              /* @__PURE__ */ new Error("There was an error establishing an SSL connection"),
            );
        }
        self.upgradeToSSL(host, reportStreamError);
      });
...
var require_client$1 = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var crypto = require_utils();
  var activeQueryDeprecationNotice = nodeUtils$1.deprecate(
    () => {},
    "Client.activeQuery is deprecated and will be removed in pg@9.0",
  );
  var queryQueueDeprecationNotice = nodeUtils$1.deprecate(
    () => {},
    "Client.queryQueue is deprecated and will be removed in pg@9.0.",
  );
  var pgPassDeprecationNotice = nodeUtils$1.deprecate(
    () => {},
    "pgpass support is deprecated and will be removed in pg@9.0. You can provide an async function as the password property to the Client/Pool constructor that returns a password instead. Within this function you can call the pgpass module in your own code.",
  );
  var byoPromiseDeprecationNotice = nodeUtils$1.deprecate(
    () => {},
    "Passing a custom Promise implementation to the Client/Pool constructor is deprecated and will be removed in pg@9.0.",
  );
  var queryQueueLengthDeprecationNotice = nodeUtils$1.deprecate(
    () => {},
  ...
  var Client = class extends EventEmitter$3 {
    ...
    _connect(callback) {
      ...
      con.once("end", () => {
        const error = this._ending
          ? /* @__PURE__ */ new Error("Connection terminated")
          : /* @__PURE__ */ new Error("Connection terminated unexpectedly");
    ...
    _handleAuthMD5Password(msg) {
      this._getPassword(async () => {
        try {
          const hashedPassword = await crypto.postgresMd5PasswordHash(
            this.user,
            this.password,
            msg.salt,
          );
    ...
    query(config, values, callback) {
      ...
      if (this._ending) {
        process.nextTick(() => {
          query.handleError(
            /* @__PURE__ */ new Error("Client was closed and is not queryable"),
            this.connection,
          );
        });
        return result;
    ...
    _afterConnect(client, pendingItem, idleListener) {
      if (this.options.maxLifetimeSeconds !== 0) {
        const maxLifetimeTimeout = setTimeout(() => {
          ...
          if (this._idle.findIndex((idleItem) => idleItem.client === client) !== -1)
            this._acquireClient(
              client,
...
var __vite_optional_peer_dep_pg_native_pg_exports = /* @__PURE__ */ __exportAll({
  default: () => __vite_optional_peer_dep_pg_native_pg_default,
});
  ...
  NativeQuery.prototype.submit = function (client) {
    ...
    if (this.name) {
      ...
      if (!Array.isArray(this.values))
        return after(/* @__PURE__ */ new Error("Query values must be an array"));
...
var require_client = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  try {
    Native =
      ...
      __toCommonJS(__vite_optional_peer_dep_pg_native_pg_exports));
  } catch (e) {
    throw e;
  }
  var TypeOverrides = require_type_overrides();
